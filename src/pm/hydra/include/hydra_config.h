...
/* C compiler */
#define HYDRA_CC "pgcc    "

/* Configure arguments */
#define HYDRA_CONFIGURE_ARGS_CLEAN "'--disable-option-checking' '--prefix=/global/homes/j/jialin/install' '--enable-fortran=no' '--cache-file=/dev/null' '--srcdir=.' 'CC=pgcc' 'CFLAGS= -O2' 'LDFLAGS= ' 'LIBS=-lrt -lgpfs -lpthread ' 'CPPFLAGS= -I/global/homes/j/jialin/mpich-ccpute/src/mpl/include -I/global/homes/j/jialin/mpich-ccpute/src/mpl/include -I/global/homes/j/jialin/mpich-ccpute/src/openpa/src -I/global/homes/j/jialin/mpich-ccpute/src/openpa/src -D_REENTRANT -I/global/homes/j/jialin/mpich-ccpute/src/mpi/romio/include'"

/* C++ compiler */
#define HYDRA_CXX "pgCC    "
...
/* Fortran 77 compiler */
#define HYDRA_F77 "pgf90   "

/* Fortran 90 compiler */
#define HYDRA_F90 "pgf90   "

/* Hydra PMI proxy executable */
#define HYDRA_PMI_PROXY "hydra_pmi_proxy"

/* Hydra release date information */
#define HYDRA_RELEASE_DATE "Mon Jul 21 16:00:21 CDT 2014"

/* Hydra version information */
#define HYDRA_VERSION "3.1.2"
...
#define PACKAGE_STRING "Hydra 3.1.2"
